# Contributing to NanoClaw Intelligence
...
3. Test locally with `cd .github-nanoclaw-intelligence && bun install` and verify dependencies install cleanly.
...
```
.github-nanoclaw-intelligence/       # Core agent framework
  .pi/                              # LLM provider configuration
  config/                           # Container and runtime configuration
...
3. Install dependencies:
   ```bash
   cd .github-nanoclaw-intelligence && bun install
   ```
