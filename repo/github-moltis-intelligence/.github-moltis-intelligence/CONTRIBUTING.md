# Contributing to Moltis Intelligence
...
- Your environment (OS, Moltis version, LLM provider).
...
3. Test locally by verifying the Moltis binary installs and runs correctly.
...
```
.github-moltis-intelligence/       # Core agent framework
  ...
  config/                          # Moltis runtime configuration (moltis.toml)
...
1. Install [Bun](https://bun.sh) (for the lifecycle orchestrator script).
2. Install [Moltis](https://github.com/moltis-org/moltis) (`curl -fsSL https://www.moltis.org/install.sh | sh`).
...
- **Orchestrator code** is TypeScript, executed with Bun.
