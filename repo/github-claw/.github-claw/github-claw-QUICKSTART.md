...
Then reference the secret in your workflow (`.github/workflows/github-claw-WORKFLOW-AGENT.yml`) as an environment variable in the **Run** step.
...
- Explore [the onboarding docs](docs/github-claw-Pi/github-claw-Pi-README.md) for deep dives into architecture, capabilities, skills, and personality
